...
public class ClubRepositoryImpl implements ClubRepository {
    ...
    public int save(Connection connection, Club club) {
        ...
        try(PreparedStatement pmst = connection.prepareStatement(sql)){
            pmst.setString(1, club.getClubId());
            pmst.setString(2, club.getClubName());
    ...
    public int update(Connection connection, Club club) {
        ...
        try(PreparedStatement pmst = connection.prepareStatement(sql)){
            pmst.setString(1, club.getClubName());
            pmst.setString(2, club.getClubId());
            return pmst.executeUpdate();
        }catch(SQLException e){
            throw new RuntimeException(e);
        }
